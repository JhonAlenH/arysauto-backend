...
const operationCreateInclusionContract = async(authHeader, requestBody) => {
    ...
    let userData = {
        xnombre: requestBody.xnombre.toUpperCase() ? requestBody.xnombre : undefined,
        ...
        xdireccionfiscal: requestBody.xdireccionfiscal.toUpperCase() ? requestBody.xdireccionfiscal : undefined,
        xserialmotor: requestBody.xserialmotor.toUpperCase() ? requestBody.xserialmotor : undefined,
        xserialcarroceria: requestBody.xserialcarroceria.toUpperCase() ? requestBody.xserialcarroceria : undefined,
        xplaca: requestBody.xplaca.toUpperCase() ? requestBody.xplaca : undefined,
        xtelefono_emp: requestBody.xtelefono_emp ? requestBody.xtelefono_emp : undefined,
        cplan: requestBody.cplan ? requestBody.cplan : undefined,
        xcedula:requestBody.xcedula ? requestBody.xcedula : undefined,
        ncapacidad_p: requestBody.ncapacidad_p ? requestBody.ncapacidad_p : undefined,
        ...
        femision: requestBody.femision ? requestBody.femision : undefined,
        cusuariocreacion: requestBody.cusuario ? requestBody.cusuario : undefined,
        fdesde_pol: requestBody.fdesde_pol ? requestBody.fdesde_pol : undefined,
        fhasta_pol: requestBody.fhasta_pol ? requestBody.fhasta_pol : undefined,
        ccarga: requestBody.ccarga ? requestBody.ccarga : undefined,
        clote: requestBody.clote ? requestBody.clote : undefined,
        msuma_a_casco: requestBody.msuma_a_casco ? requestBody.msuma_a_casco : undefined,
        mdeducible: requestBody.mdeducible ? requestBody.mdeducible : undefined,
        xpoliza: requestBody.xpoliza ? requestBody.xpoliza : undefined,
        xcertificado: requestBody.xcertificado ? requestBody.xcertificado : undefined,
